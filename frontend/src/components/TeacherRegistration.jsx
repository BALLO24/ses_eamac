                        ...
                        >
                            {
                                (formik) => (
                                    <Form className='space-y-4 md:space-y-2' action="#" onSubmit={formik.handleSubmit}>
                                        ...
                                        <div>
                                            <label htmlFor="type" className='block mb-2 text-sm font-medium text-gray-900 md:text-xl dark:text-white'>Type</label>
                                            <Field as="select" name="type" id="type" className='block w-full p-2 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus-border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                                                <option value="" selected>Choisir votre type ---</option>
                                                {dataTeachers.map(option => { return (<option key={option.value} value={option.value}>{option.name}</option>) })}
                                            </Field>
                                            <ErrorMessage name="type" className="text-red-500" component="span"></ErrorMessage>
                                        </div>
